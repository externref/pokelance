...
class Cache:
    ...
    def __init__(self, client) -> None:
        self._pokemon_cache_data: Dict[str, Union[Dict, str, int, bool, None]] = {}
    ...
    def get_sprite_for(self, pokemon: Union[Pokemon, int, str]) -> Optional[dict]:
        ...
        return Sprite(self._sprites_cache_data.get(str(pokemon))) if self._sprites_cache_data.get(str(pokemon)) else None
